...
try 
{
    using (var scope = app.Services.CreateScope()) 
    {
        ...
        // O usuário administrador é criado pelo seed inicial do AppDbContext.
        // NÃO criar usuários com senha em texto puro aqui (ver docs/PLANO_MELHORIA_HANDOFF.md, Fase 0).
