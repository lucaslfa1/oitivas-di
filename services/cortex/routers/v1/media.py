...
async def annotate_image(payload: AnnotateImageRequest):
    ...
    try:
        ...
        for ann in payload.annotations:
            t = ann.type.lower()
            coords = ann.coordinates  # [ymin, xmin, ymax, xmax] normalizados para 1000
            if len(coords) < 4:
                continue

            # Converte coordenadas normalizadas [0, 1000] para coordenadas em pixels [w, h]
            ...
            # Cor: laranja neon (0, 107, 255) em BGR
            color = (0, 107, 255)
        ...
        # Codifica de volta para JPEG -> base64
